          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: '20px' }}>
              ...
              <div style={{ flex: 1, borderLeft: '1px solid #eee', paddingLeft: '15px' }}>
                ...
                <input placeholder="Apto" value={apto} onChange={e=>setApto(e.target.value)} style={{ width: '100%', padding: '6px', margin: '3px 0', borderRadius: '4px', border: '1px solid #ccc' }}/>
                ...
                <button onClick={() => { if(!bloco || !apto) return alert("Preencha bloco/apto!"); alert("Pedido Finalizado! Retire na mercearia."); setCarrinho([]); setBloco(""); setApto(""); }} style={{ width: '100%', padding: '10px', background: '#16a34a', color: '#fff', border: 'none', borderRadius: '6px', cursor: 'pointer', marginTop: '10px', fontWeight: 'bold' }}>Finalizar</button>
              </div>
            </div>
          </div>
        )}
